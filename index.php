...
<?php require_once('include/nav.php'); ?>
          <div class="container-xxl flex-grow-1 container-p-y"><br>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <a href="javascript:void(0);" style="color: #d2d2e8;" onclick="showToastrNotification('error', 'Fake bill Momo chưa khả dụng...', 'Thông báo');">
                        <img src="https://i.imgur.com/e5S4ykm.png" width="50px" class="rounded d-block m-auto mb-2" />
                        <div class="text-center">
                          <span>Momo</span>
                          <br><small style="color:#e80221;">Sắp có</small>
                        </div>
                      </a>
                    </div>
                  </div>
                ...
                <div class="col-6 col-sm-4 col-md-3 col-xl-2 mb-3">
                  <div class="card">
                    ...
                    <a href="javascript:void(0);" style="color: #d2d2e8;" onclick="showToastrNotification('error', 'Fake bill AgriBank chưa khả dụng...', 'Thông báo');">
                        <img src="https://i.imgur.com/anbwDQk.png" width="50px" class="rounded d-block m-auto mb-2" />
                        <div class="text-center">
                          <span>AgriBank</span>
                          <br><small style="color:#e80221;">Sắp có</small>
                        </div>
            ...
            <div class="row justify-content-center">
              ...
              <h4>
                <b>Fake số dư:</b>
              </h4> Vui lòng chọn ngân hàng cần làm giả số dư: <br>
                      <br>
              <div class="row">
                <div class="col-6 col-sm-4 col-md-3 col-xl-2 mb-3">
                  <div class="card">
                    <div class="card-body">
                      <a href="fake-sodu-mbbank" style="color: #d2d2e8;">
                        <img src="https://i.imgur.com/TRv85q8.png" width="112px" class="rounded d-block m-auto mb-2" />
                        <div class="text-center">
                          <span>MBBank</span>
                          <br><small style="color:#00f259;">Hoạt Động</small>
               ...
               <div class="col-6 col-sm-4 col-md-3 col-xl-2 mb-3">
                  <div class="card">
                    <div class="card-body">
                      <a href="fake-sodu-techcombank" style="color: #d2d2e8;">
                        <img src="https://i.imgur.com/sgLMGn6.png" width="56px" class="rounded d-block m-auto mb-2" />
                        <div class="text-center">
                          <span>Techcombank</span>
                          <br><small style="color:#00f259;">Hoạt Động</small>
            ...
            <div class="row justify-content-center">
              ...
              <div class="mt-2">
              <h4>
                <b>Fake biến động số dư:</b>
              </h4> Gồm 3 ngân hàng: <br>
                      <br>
              <div class="row">
                <div class="col-6 col-sm-4 col-md-3 col-xl-2 mb-3">
                  <div class="card">
                    <div class="card-body">
                      <a href="fake-bdsd" style="color: #d2d2e8;">
                        <img src="https://sieutool.com/uploads/photoshop.png" width="63px" class="rounded d-block m-auto mb-2" />
                        <div class="text-center">
  ...
  <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl">
                <div class="footer-container d-flex align-items-center justify-content-between py-3 flex-md-row flex-column">
                  <div class="mb-2 mb-md-0">© hethongdev.store-<script>document.write(new Date().getFullYear());</script>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLongTitle"><strong>THÔNG BÁO</strong></h5>
        </button>
      </div>
...
<p><i><span style="font-family: helvetica;">Website Được Điều Hành Bởi: </span><strong><a href="https://www.facebook.com/jivan.makabi " rel="noopener" target="_blank"><span style="font-family: helvetica;">NGUYỄN VĂN MINH DUY</span></a>&nbsp;</strong></i><img alt="" data-original-height="348" data-original-width="348" height="20" src="https://blogger.googleusercontent.com/img/a/AVvXsEgTuK2vHvY-dvIdyyvVZ5-01rq5gpe8DKxJy1RLFNVElEqBXbep_l7xLwkQCKIOAYmonQNKLBwNpwEosc-k--y7IguNfzdSgX2m1GybLl9FCV9Othb67-JoaRsDjHrtifoPtTwG9XaoZLAhR74tRK5FhXTRoMy5RyV6CUlKqrzaimWIUh5bBPaSdtYylBc2=w20-h20" width="20" /></p><p><span style="font-family: helvetica;">Subscribe for me: <a href="https://hethongdev.store" target="_blank">Nguyễn Văn Minh Duy</a></span></p><p><span style="font-family: helvetica;">*</span><span style="font-family: arial;"><b style="color: red;">Lưu Ý: </b><i>website được làm ra với mục đích học tập. Mọi hành vi vi phạm pháp luật chúng tôi không chịu trách nhiệm.</i></span></p><div class="separator" style="clear: both; text-align: center;"><span style="font-family: arial;"><i><img alt="" data-original-height="500" data-original-width="1500" height="75" src="https://i.imgur.com/MW6GAxH.png" width="320" /></i></span></div>
